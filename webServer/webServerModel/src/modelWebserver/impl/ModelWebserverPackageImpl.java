...
import modelWebserver.PageTile;
 ...
 * @generated
 */
public class ModelWebserverPackageImpl extends EPackageImpl implements ModelWebserverPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see modelWebserver.ModelWebserverPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ModelWebserverPackageImpl() {
		super(eNS_URI, ModelWebserverFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ModelWebserverPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ModelWebserverPackage init() {
		if (isInited) return (ModelWebserverPackage)EPackage.Registry.INSTANCE.getEPackage(ModelWebserverPackage.eNS_URI);

		// Obtain or create and register package
		ModelWebserverPackageImpl theModelWebserverPackage = (ModelWebserverPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ModelWebserverPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ModelWebserverPackageImpl());
		...
		theModelWebserverPackage.createPackageContents();

		// Initialize created meta-data
		theModelWebserverPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theModelWebserverPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ModelWebserverPackage.eNS_URI, theModelWebserverPackage);
		return theModelWebserverPackage;
	}
	 ...
	 * @generated
	 */
	public ModelWebserverFactory getModelWebserverFactory() {
		return (ModelWebserverFactory)getEFactoryInstance();
	}
